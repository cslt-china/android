...
public class SignAlongActivity extends BaseActivity {
    ...
    public void init() {
        ...
        signAlongViewModel.checkLogin().observe(this, isLogin -> {
...
//                                }
    ...
    private void initUserData() {
        signAlongViewModel.getCurrentPointAndUsernameLiveData()
                .observe(this, currentPointAndUsername -> {
                            ...
                            if (currentPointAndUsername == null) {
                                ...
                                ((TextView) findViewById(R.id.app_title_textview)).setText(getString(R.string.app_name));
                            }
                        });
    }
